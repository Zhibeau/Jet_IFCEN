...
pass
def pro_data():
    train=pd.read_csv('C:/Users/zzhib/Desktop/particles/jet_simple_data/simple_train_R04_jet.csv')
    test=pd.read_csv('C:/Users/zzhib/Desktop/particles/jet_simple_data/simple_test_R04_jet.csv')
    ...
    test=test.drop_duplicates(subset=['event_id']).reset_index(drop=True)
    train=train.drop_duplicates(subset=['event_id']).reset_index(drop=True)
    with open('train.pkl', 'wb') as file:
        pickle.dump(train, file)
    with open('test.pkl', 'wb') as file2:
